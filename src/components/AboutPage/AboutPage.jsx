    ...
    <div className="container">
      <div>
        ...
        <p>This app was inspired by the <a href = "https://dakotaswcd.org/services/landscaping-for-clean-water/">Landscaping For Clean Water Program </a>in Dakota County, 
          ...
          about rain gardens, soil and water conservation, and Minnesota wildflowers, I wanted to create an app that would connect folks who are interested in 
          learning more about rain gardens with resources and programs in our local communities for desigining and installing rain gardens. While this app is currently specific to building rain gardens in Minnesota, I hope to expand this app in the future to include many different regions.
        </p>
